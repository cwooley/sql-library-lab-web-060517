...
def select_name_and_series_subgenres_of_authors
  ...
  FROM authors JOIN series ON authors.id = series.author_id JOIN subgenres ON subgenres.id = series.subgenre_id "
end
...
def select_character_names_and_number_of_books_they_are_in
  ...
  FROM characters JOIN character_books on characters.id = character_books.character_id JOIN books ON character_books.book_id = books.id
